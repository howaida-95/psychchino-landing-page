...
export function Hero() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-background px-4 pb-20 pt-12 sm:px-6 sm:pt-16 lg:px-8 lg:pb-28">
      <div
      ...
      <div
        ...
        aria-hidden
      />
      <div className="relative z-10 mx-auto grid max-w-6xl gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center lg:gap-16">
